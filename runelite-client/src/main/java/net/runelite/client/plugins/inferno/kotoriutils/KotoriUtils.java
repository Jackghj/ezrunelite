...
import net.runelite.client.plugins.kotoriutils.gson.HookInfo;
import net.runelite.client.plugins.kotoriutils.gson.Hooks;
import net.runelite.client.plugins.kotoriutils.methods.MiscUtilities;
import net.runelite.client.plugins.kotoriutils.methods.PrayerInteractions;
